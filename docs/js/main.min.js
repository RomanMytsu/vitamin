...
/***/ "./src/ts/burger-menu/burger-menu.ts"
/*!*******************************************!*\
  !*** ./src/ts/burger-menu/burger-menu.ts ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const initBurgerMenu = () => {
    ...
    if (!burgerBtn || !menu)
        return;
    const views = menu.querySelectorAll(".burger-menu__view");
    let activeView = "main";
    views.forEach((view) => {
...
/***/ "./src/ts/home-page/product-swiper.ts"
/*!********************************************!*\
  !*** ./src/ts/home-page/product-swiper.ts ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
document.addEventListener("DOMContentLoaded", () => {
    const slider = document.querySelector(".product__slider-wrapper");
    if (!slider)
        return;
...
document.addEventListener("DOMContentLoaded", () => {
    const reviewsSlider = document.querySelector(".reviews__slider-wrapper");
    if (!reviewsSlider)
        return;
...
/***/ "./src/ts/sign-up/rendering-form.ts"
/*!******************************************!*\
  !*** ./src/ts/sign-up/rendering-form.ts ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function renderForm(type) {
    ...
    if (type === "wholesale")
        initWholesaleValidation();
}
function initWholesaleValidation() {
    if (!formContainer)
        return;
    const form = formContainer.querySelector(".sign-up__form");
    const inputs = form?.querySelectorAll(".sign-up__input");
    const button = form?.querySelector(".sign-up__btn-form");
    if (!form || !inputs || !button)
        return;
    const checkInputs = () => {
...
tabs.forEach((tab) => {
    tab.addEventListener("click", () => {
        ...
        if (type !== "regular" && type !== "wholesale")
            return;
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _burger_menu_burger_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./burger-menu/burger-menu */ "./src/ts/burger-menu/burger-menu.ts");
/* harmony import */ var _home_page_product_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home-page/product-swiper */ "./src/ts/home-page/product-swiper.ts");
/* harmony import */ var _sign_up_rendering_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sign-up/rendering-form */ "./src/ts/sign-up/rendering-form.ts");
